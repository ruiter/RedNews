...
data class PostsListBusinness(
    val kind: String,
    val dataBusinness: DataBusinness
)

data class DataBusinness(
...
data class DataChildrenBusinness(
    val title: String,
...
data class ImagesBusinnes(
    val source: SourceBusinnes,
    val resolutions: MutableList<ResolutionsBusinnes>
)

data class SourceBusinnes(
    val url: String,
    val width: Int,
    val height: Int
)

data class ResolutionsBusinnes(
    val url: String,
    val width: Int,
    val height: Int
)